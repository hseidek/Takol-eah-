...
class AddLunchMeals extends StatefulWidget {
  @override
  _AddLunchMealsState createState() => _AddLunchMealsState();
}

class _AddLunchMealsState extends State<AddLunchMeals> {
  List<String> nameOfMeals = List<String>();

  bool _validate = false;
  TextEditingController nameController = TextEditingController();

  _saveLunchList(List<String> list) async {
  ...
  Future<List<String>> _readLunchList() async {
    try {
      final prefs = await SharedPreferences.getInstance();
      final key = 'lunch list';
        ...
        body: Column(
          children: [
            ...
            RaisedButton(
              ...
              onPressed: () {
                addItemToList();
                _saveLunchList(nameOfMeals);
              },
            ),
            Expanded(
              child: FutureBuilder(
                future: _readLunchList(),
